...
public class ResourceCompiler extends DefaultTask implements FilenameFilter {
    ...
    public ResourceCompiler() {
        ...
        compileSourceSets = sourceSets.getByName(SourceSet.MAIN_SOURCE_SET_NAME).getAllSource();
     ...
     * Executes the plugin.
     *
     * @throws org.gradle.api.GradleException if the plugin execution failed.
     */
    @TaskAction
